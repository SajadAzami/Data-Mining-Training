...
"""Just a smaller version of prediction(with lower portion of the data)"""

# Load the data
train_df = pd.read_csv('../data_set/orders_train.txt', sep=';', header=0, nrows=2000)
test_df = pd.read_csv('../data_set/orders_class.txt', sep=';', header=0, nrows=100)
